...
type sfpsla struct {
	...
	//                test type:   0     0     1  - test RFC 2544 - Пропускная способность
	//                test type:   0     1     0  - test RFC 2544 - Задержка
	//                test type:   0     1     1  - test RFC 2544 - Потеря пакетов
	//                test type:   1     0     0  - test RFC 2544 - Берстность
