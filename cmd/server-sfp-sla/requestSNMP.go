...
func findSFP(c net.PacketConn, addr net.Addr, ip_server string, ip_1sfpsla_str string, ip_2sfpsla_str string, mac_src []byte, mac_dst []byte, mac_dst2 []byte, test_type uint16, test_Way int, packet_size int, period_nano_gen_s int64) int {
	...
	if (((SFP1_com > 0.8*float32(step1)) || (SFP1_laz > 0.8*float32(step1))) && // throuth OK
		...
		if ((SFP1_com > 0.8*float32(step1) && SFP1_com < 1.2*float32(step1)) && (SFP1_laz > 0.8*float32(step1) && SFP1_laz < 1.2*float32(step1))) &&
			...
			((((SFP1_laz_rev > 0) && (SFP1_com_rev/(SFP1_laz_rev) > 1.4)) || ((SFP1_com_rev > 0) && (SFP1_laz_rev/(SFP1_com_rev) > 1.4))) ||
				(((SFP2_laz_rev > 0) && (SFP2_com_rev/(SFP2_laz_rev) > 1.4)) || ((SFP2_com_rev > 0) && (SFP2_laz_rev/(SFP2_com_rev) > 1.4)))) {
			return 0x999
		} else {
			if (((SFP2_com_rev > 0.8*float32(step1) && SFP2_com_rev < 1.2*float32(step1)) && (SFP2_laz_rev > 0.8*float32(step1) && SFP2_laz_rev < 1.2*float32(step1))) &&
				((SFP1_com_rev > 0.8*float32(step1) && SFP1_com_rev < 1.2*float32(step1)) || (SFP1_laz_rev > 0.8*float32(step1) && SFP1_laz_rev < 1.2*float32(step1)))) &&
				((((SFP1_laz > 0) && (SFP1_com/(SFP1_laz) > 1.4)) || ((SFP1_com > 0) && (SFP1_laz/(SFP1_com) > 1.4))) ||
					(((SFP2_laz > 0) && (SFP2_com/(SFP2_laz) > 1.4)) || ((SFP2_com > 0) && (SFP2_laz/(SFP2_com) > 1.4)))) {
				return 0x1999
			}
		}
		if (SFP1_com < float32(800)) && (SFP1_laz < float32(800)) && (SFP2_com < float32(800)) && (SFP2_laz < float32(800)) &&
			(SFP1_com_rev < float32(800)) && (SFP1_laz_rev < float32(800)) && (SFP2_com_rev < float32(800)) && (SFP2_laz_rev < float32(800)) {
			return 0x2999
		}
		if ((SFP1_com > float32(850) && SFP1_laz < 0.3*float32(step1)) || (SFP1_laz > float32(850) && SFP1_com < 0.3*float32(step1))) &&
		...
		if ((SFP2_com_rev > float32(850) && SFP2_laz_rev < 0.3*float32(step1)) || (SFP2_laz_rev > float32(850) && SFP2_com_rev < 0.3*float32(step1))) &&
	...
	SFP1_com = SFP1_com_s2 - SFP1_com_init
	SFP1_laz = SFP1_laz_s2 - SFP1_laz_init
	SFP2_com = SFP2_com_s2 - SFP2_com_init
	SFP2_laz = SFP2_laz_s2 - SFP2_laz_init

	SFP1_com_rev = SFP1_com_s2_rev - SFP1_com_init
	SFP1_laz_rev = SFP1_laz_s2_rev - SFP1_laz_init
	SFP2_com_rev = SFP2_com_s2_rev - SFP2_com_init
	SFP2_laz_rev = SFP2_laz_s2_rev - SFP2_laz_init
	...
	SFP1_com = SFP1_com_s3 - SFP1_com_init
	SFP1_laz = SFP1_laz_s3 - SFP1_laz_init
	SFP2_com = SFP2_com_s3 - SFP2_com_init
	SFP2_laz = SFP2_laz_s3 - SFP2_laz_init

	SFP1_com_rev = SFP1_com_s3_rev - SFP1_com_init
	SFP1_laz_rev = SFP1_laz_s3_rev - SFP1_laz_init
	SFP2_com_rev = SFP2_com_s3_rev - SFP2_com_init
	SFP2_laz_rev = SFP2_laz_s3_rev - SFP2_laz_init
	...
	/*
			...
			period_nano_gen := (int64)(packet_size_generate*period_nano_gen_s) / (int64)(packet_size)
...
func check_SNMP(ip string) int {
	...
	<-done
	if verboseLogs {
		fmt.Printf("\nTest SFP - module : %s, rez = %d / 5", ip, rez)
	}
	if rez > 3 {
		return 0
	} else {
