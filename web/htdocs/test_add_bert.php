                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon md-chart" aria-hidden="true"></i>Maximum-load throughput test</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="action_add_test_bert_go.php" class="form-horizontal"
                                  autocomplete="off">
                                ...
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Maximum available throughput
                                        [Mbit/s]</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="thr_begin" class="form-control" value="1000"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Single measurement period (seconds)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_prob_packs" class="form-control" value="10"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Number of test measurements</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_probs" class="form-control" value="3"/>
                                    </div>
                                </div>
