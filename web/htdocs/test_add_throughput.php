                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon md-chart" aria-hidden="true"></i>Throughput load test</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="action_add_test_throughput_go.php" class="form-horizontal"
                                 autocomplete="off">
                                ...
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Maximum available throughput [Mbit/s]</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="clock" class="form-control" value="1000"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Single test period (seconds)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count" class="form-control" value="20"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Load change type</label>
                                    <div class="col-sm-9">
                                        <select name="ch_type" class="form-control">
                                            <option value="0">Binary search</option>
                                            <option value="1">Decrease by 10%</option>
                                            <option value="2">Decrease by 1%</option>
                                            <option value="3">Decrease by 0.01%</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Loss threshold [%]</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="max_loss" class="form-control" value="0"/>
                                    </div>
                                </div>
