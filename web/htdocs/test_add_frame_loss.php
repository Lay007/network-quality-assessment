                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon md-chart" aria-hidden="true"></i>Frame loss ratio load test</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="action_add_test_loss_go.php" class="form-horizontal"
                                 autocomplete="off">
                                ...
                                <div class="form-group form-material">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="thr_begin" class="form-control" value="200"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Test generation period (seconds)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_frames" class="form-control" value="10"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Load step</label>
                                    <div class="col-sm-9">
                                        <select name="step" class="form-control">
                                            <option value="1">Decrease by 1%</option>
                                            <option value="5">Decrease by 5%</option>
                                            <option selected value="10">Decrease by 10%</option>
                                            <option value="20">Decrease by 20%</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Step count</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_steps" class="form-control" value="5"/>
                                    </div>
                                </div>
