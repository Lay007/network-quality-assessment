...
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests = mysqli_num_rows($search);
} else {
    $number_tests = 0;
}
$sql = "select * from `test_bert`";
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests += mysqli_num_rows($search);
}

$sql = "select * from `test_frame_loss`";
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests += mysqli_num_rows($search);
}

$sql = "select * from `test_throughput`";
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests += mysqli_num_rows($search);
}

$sql = "select * from `test_latency`";
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests += mysqli_num_rows($search);
}

$sql = "select * from `test_y1564`";
$search = mysqli_query($link, $sql);
if ($search) {
    $number_tests += mysqli_num_rows($search);
}
        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
                        ...
                        <div class="widget-content">
                            <div class="padding-20 padding-top-10">
                                <div class="clearfix">
                                    ...
                                    <span class="pull-right grey-700 font-size-30"><?php echo $server_IP; ?></span>
                                </div>
                    ...
                    <a href="global_edite.php">
                        <div class="widget-content">
                            <div class="padding-20 padding-top-10">
                                <div class="clearfix">
                                    <div class="grey-800 pull-left padding-vertical-10">
                                        <i class="icon md-flash grey-600 font-size-24 vertical-align-bottom margin-right-5"></i>VLAN
                                    </div>
                                    <span class="pull-right grey-700 font-size-30"><?php if ($VLAN) {
                                            echo $VLAN_number;
                                        } else {
                                            echo "";
                                        } ?></span>
                                ...
                                <div class="margin-bottom-20 grey-500">
                                    <i class="green-500 font-size-16"></i><?php if ($VLAN) {
                                        echo "VLAN ID";
                                    } else {
                                        echo "VLAN is not used";
                                    } ?>
                                </div>
                                <div class="ct-chart height-50"></div>
                            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="widget widget-shadow" id="widgetLineareaFour">
                    <a href="module_view_all.php">
                        <div class="widget-content">
                            <div class="padding-20 padding-top-10">
                                <div class="clearfix">
                                    <div class="grey-800 pull-left padding-vertical-10">
                                        <i class="icon md-view-list grey-600 font-size-24 vertical-align-bottom margin-right-5"></i>Number of SFP-SLA modules
                                    </div>
                                    <span class="pull-right grey-700 font-size-30"><?php echo $number_sfp; ?></span>
                                </div>
                                <div class="margin-bottom-20 grey-500">
                                    <i class="green-500 font-size-16"></i>
                                </div>
                                <div class="ct-chart height-50"></div>
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="widget widget-shadow" id="widgetLineareaThree">
                    <a href="tests_view_all.php">
                        <div class="widget-content">
                            <div class="padding-20 padding-top-10">
                                <div class="clearfix">
                                    <div class="grey-800 pull-left padding-vertical-10">
                                        <i class="icon md-chart grey-600 font-size-24 vertical-align-bottom margin-right-5"></i>Number of SLA tests
                                    </div>
                                    <span class="pull-right grey-700 font-size-30"><?php echo $number_tests; ?></span>
                                </div>
                                <div class="margin-bottom-20 grey-500">
                                    <i class="red-500 font-size-16"></i>
                                </div>
                                <div class="ct-chart height-50"></div>
                            </div>
                        </div>
