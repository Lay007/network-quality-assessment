                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon md-chart" aria-hidden="true"></i>Latency load test</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="action_add_test_latency_go.php" class="form-horizontal"
                                 autocomplete="off">
                                ...
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Number of test generations</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_tests" class="form-control" value="10"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Single generation time (seconds)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count_packs" class="form-control" value="10"/>
                                    </div>
                                </div>
