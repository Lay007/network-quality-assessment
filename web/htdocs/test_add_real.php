                ...
                <div class="col-lg-12">
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon md-chart" aria-hidden="true"></i>Add SLA test
                                in real-time mode</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="action_add_test_real_go.php" class="form-horizontal"
                                  autocomplete="off">
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">SLA test name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="test_name" class="form-control" value="SLA test"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="test_type" class="form-control">
                                            <option value="1">Test between SFP-SLA-1 and SFP-SLA-2 modules
                                            </option>
                                            <option value="2">Test between monitoring server and module
                                                SFP-SLA-1
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Packet generation period, ms</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="clock" class="form-control" value="1000"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Generation count (0 - continuous)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="count" class="form-control" value="0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Two-way latency threshold [us]<br>(0 disables threshold)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="delay_max" class="form-control" value="0.0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Two-way latency jitter threshold [us]<br>(0 disables threshold)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="jitter_max" class="form-control" value="0.0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">One-way latency threshold [us]<br>(0 disables threshold)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="delay1_max" class="form-control" value="0.0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">One-way latency jitter threshold [us]<br>(0 disables threshold)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="jitter1_max" class="form-control" value="0.0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                    <label class="col-sm-3 control-label">Packet loss ratio threshold<br>(0 disables threshold)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="loss_max" class="form-control" value="0.0"/>
                                    </div>
                                </div>
                                <div class="form-group form-material">
                                        ...
                                        <div class="panel-action">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" checked="true" class="custom-control-input col-sm-1"
                                                       name="test_delay">
                                                <label class="custom-control-label col-sm-5">Analyze two-way latency</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel-action">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" checked="true" class="custom-control-input col-sm-1"
                                                       name="test_jitter">
                                                <label class="custom-control-label col-sm-5">Analyze two-way latency jitter</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel-action">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" checked="true" class="custom-control-input col-sm-1"
                                                   name="test_delay_1">
                                            <label class="custom-control-label col-sm-5"> Analyze one-way latency </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-action">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" checked="true" class="custom-control-input col-sm-1"
                                                   name="test_jitter_delay_1">
                                            <label class="custom-control-label col-sm-5"> Analyze one-way latency jitter </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-action">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" checked="true" class="custom-control-input col-sm-1"
                                                   name="test_loss">
                                            <label class="custom-control-label col-sm-5">Analyze packet loss ratio</label>
                                        </div>
                                    </div>
