...
$net_interface_name=$row["net_interface_name"];
$QinQ = $row["QinQ"];
$QinQ_number = $row["QinQ_number"];
?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-bordered">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="icon md-globe-alt" aria-hidden="true"></i>Global settings</h3>
                            </div>
                            <div class="panel-body">
                                <form method=post action='action_config_go.php' class="form-horizontal"
                                      autocomplete="off">

                                    <div class="form-group form-material">
                                        <label class="col-sm-3 control-label">Controller server IP address</label>
                                        <div class="col-sm-9">
                                            <input required pattern="^([0-9]{1,3}\.){3}[0-9]{1,3}$"
                                                   value="<?php echo $server_IP;?>" type="text" name=server_ip class="form-control"/>
                                        </div>
                                    </div>

                                    <div class="form-group form-material">
                                        <label class="col-sm-3 control-label">Network interface name</label>
                                        <div class="col-sm-9">
                                            <select name="net_interface_name" class="form-control">
                                            <?php
                                            $sql = "select * from net_interfaces_from_server_sla";
                                            $search = mysqli_query($link, $sql);
                                            $row = mysqli_fetch_array($search);
                                            do {
                                                if ($row ["name"]==$net_interface_name && $row ["address_IP"]==$server_IP) {
                                                    printf("<option selected value=\"" . $row ["name"] . "\">" . $row ["name"] . " : IP= " . $row ["address_IP"] . " : MAC= " . $row ["address_mac"] . "</option>");
                                                }else
                                                {
                                                    printf("<option value=\"" . $row ["name"] . "\">" . $row ["name"] . " : IP= " . $row ["address_IP"] . " : MAC= " . $row ["address_mac"] . "</option>");
                                                }
                                ...
                                <!--
                                    <div class="form-group form-material">
                                        <label class="col-sm-3 control-label">Use VLAN</label>
                                        <div class="col-sm-9">
                                            <input type=checkbox <?php if ($VLAN) {echo 'checked';} ?> value="1" name=vlan_check align="left">
                                    ...
                                    <div class="form-group form-material">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="<?php echo $VLAN_number;?>" type="text" name=vlan_number class="form-control"/>
                                        </div>
                                    </div>

                                    <div class="form-group form-material">
                                        <label class="col-sm-3 control-label">Use QinQ</label>
                                        <div class="col-sm-9">
                                            <input type=checkbox <?php if ($QinQ) {echo 'checked';} ?> value="1" name=QinQ_check align="left">

                                        </div>
                                    </div>

                                    <div class="form-group form-material">
                                        <label class="col-sm-3 control-label">QinQ ID</label>
                                        <div class="col-sm-9">
                                            <input value="<?php echo $QinQ_number;?>" type="text" name=QinQ_number class="form-control"/>
                                        </div>
                                    </div>
                                -->
