                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-bordered">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="icon md-globe-alt" aria-hidden="true"></i>Select module to delete</h3>
                            </div>
                            <div class="panel-body">
                                <form method="post" action="action_del_module_go.php" class="form-horizontal"
                                      autocomplete="off">
                                    ...
                                    <div class="form-group form-material">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="module_name" class="form-control">
                                                ...
                                                $sql = "select name from modules_sfp_sla";
                                                $search = mysqli_query($link, $sql);
