...
func findSFP(c net.PacketConn, addr net.Addr, ip_1sfpsla_str string, ip_2sfpsla_str string, ip_server string, mac_src []byte, mac_dst []byte, test_type uint16, testWay int) bool {
